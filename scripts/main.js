;(function (window) {
  ...
  let texts = ['HI SHEILAA JANGAN LUPA TAP','JANGAN LUPA', 'PAKAI LANDSCAPE MODE', 'HI', 'COBA LIHAT DEH', 'KATA KATA INI', 'KEK ADA YANG ANEH', 'AYO PENCET LAGI', 'AKU GA BOHONG KOK', 'PENCET LAGI', 'AKU TAHU KAMU PASTI KESAL', 'PENCET LAGI', 'HAHAHAHAHHAHA GOOD NIGHT <3', 'MAAF YAAA UDH BUAT KESAAL WLEE']
